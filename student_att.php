            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="container rounded bg-white mt-5 mb-5">
                    <table id="table" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                            $attendance_qry = $conn->query("SELECT a.*, CONCAT(e.firstname,' ',e.middlename,' ',e.lastname) AS name, e.student_no FROM std_attend a INNER JOIN student e ON a.student_id = e.id WHERE a.student_id = $id ");
