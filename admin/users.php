				...
				<div class="modal-dialog" role="document">
					<div class="modal-content ">
						<div class="modal-body">
							<center><label class="text-danger">هل أنت متأكد أنك تريد الحذف?</label></center>
							<br />
							<center><a class="btn btn-danger remove_id" ><span class="glyphicon glyphicon-trash"></span> نعم</a> <button type="button" class="btn btn-warning" data-dismiss="modal" aria-label="No"><span class="glyphicon glyphicon-remove"></span> لا</button></center>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content panel-warning">
						<div class="modal-header panel-heading">
							...
							<h4 class="modal-title" id="manage_userlabel">تعديل بيانات الادمن</h4>
						</div>
						<div id="edit_query"></div>
					</div>
				</div>
			</div>
			<div class="alert alert-primary">حساب الادمن</div>
			<div class="well col-lg-12">
				<button type="button" class="btn btn-primary btn-sm" id="new_user"><i class="fa fa-plus"></i> إضافة جديد </button>
				<br />
				<br />
					...
					<div class="modal-content panel-primary">
						...
						<form id="user-frm">
							...
							<div class="modal-footer">
								<button  class="btn btn-primary" name="save">حفظ</button>
							</div>
						</form>
					</div>
				</div>
