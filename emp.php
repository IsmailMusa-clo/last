        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="container rounded bg-white mt-5 mb-5">
                    <div class="row">
                        <div class="col-md-2"> 
                            <!-- <a href="auto_emp.php?g=<?=$user['employee_no']?>">QR Generator</a> -->
                        </div>
                        <div class="col-md-8  border-right">
                            <form id="employee_frm">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-6"><label class="labels">رقم الموظف </label><input type="text" name="employee_no" class="form-control" disabled placeholder="employee number" value="<?= $user['employee_no'] ?>"></div>
                                    <div class="col-md-6"><label class="labels">كلمة المرور </label><input type="text" name="password" class="form-control" placeholder="employee password" value="<?= $user['password'] ?>"></div>
                                    ...
                                    <div class="col-md-12"><label class="labels">المسمى الوظيفي</label><input type="text" name="position" class="form-control" placeholder="position" value="<?= $user['position'] ?>"></div>
